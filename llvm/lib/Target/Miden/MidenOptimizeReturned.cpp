//===-- MidenOptimizeReturned.cpp - Optimize "returned" attributes --===//
//
...
///
/// \file
/// Optimize calls with "returned" attributes for Miden.
///
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "miden-optimize-returned"

namespace {
class OptimizeReturned final : public FunctionPass,
                               public InstVisitor<OptimizeReturned> {
  StringRef getPassName() const override { return "Miden Optimize Returned"; }
...
INITIALIZE_PASS(OptimizeReturned, DEBUG_TYPE,
                "Optimize calls with \"returned\" attributes for Miden", false,
                false)

FunctionPass *llvm::createMidenOptimizeReturned() {
