// MidenFrameLowering.h - TargetFrameLowering for Miden -*- C++ -*-/
//
...
///
/// \file
/// This class implements Miden-specific bits of
/// TargetFrameLowering class.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_MIDEN_MIDENFRAMELOWERING_H
#define LLVM_LIB_TARGET_MIDEN_MIDENFRAMELOWERING_H

#include "llvm/CodeGen/TargetFrameLowering.h"

namespace llvm {

class MidenFrameLowering final : public TargetFrameLowering {
public:
  ...
  // Returns the index of the Miden local to which the stack object
