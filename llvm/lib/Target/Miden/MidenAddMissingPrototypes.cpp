//===-- MidenAddMissingPrototypes.cpp - Fix prototypeless functions -===//
//
...
///
/// Miden has strict function prototype checking so we need functions
...
/// doesn't under Miden.  This pass will find all the call sites of each
...
#define DEBUG_TYPE "miden-add-missing-prototypes"

namespace {
class MidenAddMissingPrototypes final : public ModulePass {
...
public:
  static char ID;
  MidenAddMissingPrototypes() : ModulePass(ID) {}
};
} // End anonymous namespace

char MidenAddMissingPrototypes::ID = 0;
INITIALIZE_PASS(MidenAddMissingPrototypes, DEBUG_TYPE,
                "Add prototypes to prototypes-less functions", false, false)

ModulePass *llvm::createMidenAddMissingPrototypes() {
  return new MidenAddMissingPrototypes();
}

bool MidenAddMissingPrototypes::runOnModule(Module &M) {
