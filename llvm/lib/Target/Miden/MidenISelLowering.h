//- MidenISelLowering.h - Miden DAG Lowering Interface -*- C++ -*-//
//
...
///
/// \file
/// This file defines the interfaces that Miden uses to lower LLVM
/// code into a selection DAG.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_MIDEN_MIDENISELLOWERING_H
#define LLVM_LIB_TARGET_MIDEN_MIDENISELLOWERING_H
...
} // end namespace MidenISD

class MidenSubtarget;

class MidenTargetLowering final : public TargetLowering {
public:
  MidenTargetLowering(const TargetMachine &TM, const MidenSubtarget &STI);
...
private:
  ...
  const char *getClearCacheBuiltinName() const override {
    report_fatal_error("llvm.clear_cache is not supported on miden");
  }
