// MidenDebugValueManager.h - Miden DebugValue Manager -*- C++ -*-//
//
...
#ifndef LLVM_LIB_TARGET_MIDEN_MIDENDEBUGVALUEMANAGER_H
#define LLVM_LIB_TARGET_MIDEN_MIDENDEBUGVALUEMANAGER_H
...
class MidenDebugValueManager {
  SmallVector<MachineInstr *, 2> DbgValues;
  unsigned CurrentReg;

public:
  MidenDebugValueManager(MachineInstr *Instr);
