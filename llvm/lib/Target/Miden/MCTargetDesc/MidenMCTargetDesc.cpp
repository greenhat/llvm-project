//===-- MidenMCTargetDesc.cpp - Miden Target Descriptions -----===//
//
...
#include "MCTargetDesc/MidenMCAsmInfo.h"
...
#define DEBUG_TYPE "miden-mc-target-desc"
...
static MCAsmInfo *createMCAsmInfo(const MCRegisterInfo & /*MRI*/,
  ...
  return new MidenMCAsmInfo(TT, Options);
}

static MCInstrInfo *createMCInstrInfo() {
  auto *X = new MCInstrInfo();
  InitMidenMCInstrInfo(X);
  return X;
}

static MCRegisterInfo *createMCRegisterInfo(const Triple & /*T*/) {
  auto *X = new MCRegisterInfo();
  InitMidenMCRegisterInfo(X, 0);
  return X;
}
...
static MCInstPrinter *createMCInstPrinter(const Triple & /*T*/,
  ...
  assert(SyntaxVariant == 0 && "Miden only has one syntax variant");
  return new MidenInstPrinter(MAI, MII, MRI);
}

static MCCodeEmitter *createCodeEmitter(const MCInstrInfo &MCII,
                                        MCContext &Ctx) {
  return createMidenMCCodeEmitter(MCII);
}
...
static MCAsmBackend *createAsmBackend(const Target & /*T*/,
                                      ...
                                      const MCRegisterInfo & /*MRI*/,
                                      const MCTargetOptions & /*Options*/) {
  return createMidenAsmBackend(STI.getTargetTriple());
}

static MCSubtargetInfo *createMCSubtargetInfo(const Triple &TT, StringRef CPU,
                                              StringRef FS) {
  return createMidenMCSubtargetInfoImpl(TT, CPU, /*TuneCPU*/ CPU, FS);
}

static MCTargetStreamer *
createObjectTargetStreamer(MCStreamer &S, const MCSubtargetInfo &STI) {
  return new MidenTargetMidenStreamer(S);
}
...
static MCTargetStreamer *createAsmTargetStreamer(MCStreamer &S,
                                                 ...
                                                 bool /*isVerboseAsm*/) {
  return new MidenTargetAsmStreamer(S, OS);
}

static MCTargetStreamer *createNullTargetStreamer(MCStreamer &S) {
  return new MidenTargetNullStreamer(S);
}

// Force static initialization.
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeMidenTargetMC() {
  for (Target *T : {&getTheMidenTarget32(), &getTheMidenTarget64()}) {
