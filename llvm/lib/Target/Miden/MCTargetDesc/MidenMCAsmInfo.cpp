//===-- MidenMCAsmInfo.cpp - Miden asm properties -------------===//
//
...
///
/// \file
/// This file contains the declarations of the MidenMCAsmInfo
/// properties.
///
//===----------------------------------------------------------------------===//

#include "MidenMCAsmInfo.h"
#include "Utils/MidenUtilities.h"
#include "llvm/ADT/Triple.h"

using namespace llvm;

#define DEBUG_TYPE "miden-mc-asm-info"

MidenMCAsmInfo::~MidenMCAsmInfo() = default; // anchor.

MidenMCAsmInfo::MidenMCAsmInfo(const Triple &T,
  ...
  if (Miden::MidenEnableEH || Miden::MidenEnableSjLj)
    ExceptionsType = ExceptionHandling::Miden;
}
