...
///
/// CodeGen uses external symbols, which it refers to by name. The Miden
...
void llvm::getLibcallSignature(const MidenSubtarget &Subtarget,
                               RTLIB::Libcall LC,
  ...
  case func:
    break;
  case f32_func_f32:
    Rets.push_back(miden::ValType::F32);
    Params.push_back(miden::ValType::F32);
    break;
  case f32_func_f64:
    Rets.push_back(miden::ValType::F32);
    Params.push_back(miden::ValType::F64);
    break;
  case f32_func_i32:
    Rets.push_back(miden::ValType::F32);
    Params.push_back(miden::ValType::I32);
    break;
  case f32_func_i64:
    Rets.push_back(miden::ValType::F32);
    Params.push_back(miden::ValType::I64);
    break;
  case f32_func_i16:
    Rets.push_back(miden::ValType::F32);
    Params.push_back(miden::ValType::I32);
    break;
  case f64_func_f32:
    Rets.push_back(miden::ValType::F64);
    Params.push_back(miden::ValType::F32);
    break;
  case f64_func_f64:
    Rets.push_back(miden::ValType::F64);
  ...
  case f64_func_i64:
    ...
    break;
  case i32_func_f32:
    Rets.push_back(miden::ValType::I32);
    Params.push_back(miden::ValType::F32);
    break;
  case i32_func_f64:
    Rets.push_back(miden::ValType::I32);
  ...
  case i32_func_i32:
    ...
    break;
  case i64_func_f32:
    Rets.push_back(miden::ValType::I64);
    Params.push_back(miden::ValType::F32);
    break;
  case i64_func_f64:
    Rets.push_back(miden::ValType::I64);
...
#if 0 // TODO: Enable this when miden gets multiple-return-value support.
    Rets.push_back(miden::ValType::I64);
    Rets.push_back(miden::ValType::I64);
#else
    Params.push_back(PtrTy);
...
void llvm::getLibcallSignature(const MidenSubtarget &Subtarget, StringRef Name,
                               SmallVectorImpl<miden::ValType> &Rets,
                               SmallVectorImpl<miden::ValType> &Params) {
